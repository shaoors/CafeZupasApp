...
public class SignInTest extends BaseSetup {
    ...
    public void testLogin() {
        ...
        Assert.assertTrue(
            actualWelcomeText.contains(expectedWelcomeText),
            "Welcome screen text mismatch! Expected: \"" + expectedWelcomeText + "\", but found: \"" + actualWelcomeText + "\""
        );
    }
    ...
    public void LoginTestWithWrongCreds() {
        ...
        Assert.assertTrue(
            loginPage.isToastMessageCorrect("The email or password you entered is incorrect."),
