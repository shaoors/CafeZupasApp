...
public class LoginPage {
    ...
    private By toastMessage = By.xpath(".//android.widget.TextView[contains(@text, 'The email or password you entered is incorrect.')]");
    ...
    public boolean isToastMessageCorrect(String expectedMessage) {
        WebElement toast = driver.findElement(toastContainer).findElement(toastMessage);
        return toast.isDisplayed() && toast.getText().contains(expectedMessage);
    }
}
