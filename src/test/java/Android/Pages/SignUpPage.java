...
public class SignUpPage {
    ...
    // Locators
    private By signUpWithEmailButton = AppiumBy.androidUIAutomator("new UiSelector().textContains(\"SIGN UP WITH EMAIL\")");
...
//    private By signUpButton = By.xpath("//android.view.ViewGroup[contains(@resource-id, 'SIGNUP_BUTTON')]");
    ...
    private By toastMessage = By.xpath(".//android.widget.TextView[contains(@text, 'The email has already been taken.')]");
    ...
    public void verifyToastMessage(String expectedMessage) {
        ...
        Assert.assertTrue(
            toastElement.getText().contains(expectedMessage),
            "Toast message text mismatch! Expected: \"" + expectedMessage + "\", but found: \"" + toastElement.getText() + "\""
        );
    }
}
